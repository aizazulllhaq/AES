...
const products = productsInt.map(p => ({ ...p, id: String(p.id) }))
// console.log("Products :",new Set([...products.map(p => p.category)]))
...
// brands.map(b => (console.log({ value: b, label: b, checked: false }, ",")))

// products.map(p => (console.log({ ...p, id: String(p.id) })))