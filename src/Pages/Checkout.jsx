        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
                  ...
                  <ul role="list">
                    {user.addresses &&
                      user.addresses.map((address, index) => (
                        <li
                          key={index}
                          className="flex justify-between gap-x-6 py-5 border border-solid border-2 border-gray-200 px-5 my-1"
                        >
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mx-auto mt-12 max-w-7xl px-4 sm:px-6 lg:px-8 bg-white">
              <div className="border-t border-gray-200 px-2 sm:px-2 lg:px-4 py-6">
