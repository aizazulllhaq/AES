        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
                <div className="lg:col-span-3">
                    <form className='bg-white px-5 my-12'>
                        <div className="space-y-12">


                            <div className="border-b border-gray-900/10 pb-12 py-4">
                                <h2 className="text-base font-semibold leading-7 text-gray-900 text-xl">Personal Information</h2>
                            ...
                            <div className="border-b border-gray-900/10 pb-12">
                                ...
                                <ul role="list">
                                    {addresses.map((address) => (
                                        <li key={address.email} className="flex justify-between gap-x-6 py-5 border border-solid border-2 border-gray-200 px-5 my-1">
                ...
                <div className="lg:col-span-2">
                    ...
                    <div className='mx-auto mt-12 max-w-7xl px-0 sm:px-0 lg:px-0 bg-white'>
                        <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                            <h1 className='text-4xl tracking-light text-gray-900 font-bold my-5'>Cart</h1>
