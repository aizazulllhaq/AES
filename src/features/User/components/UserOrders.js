                ...
                <div className="flex min-w-0 gap-x-4 border-gray-500">
                  <div className="min-w-0 flex-auto">
                    <p className="text-sm font-semibold leading-6 text-gray-900">
                      {order.selectAddress && order.selectAddress.name}
                    </p>
                    <p className="mt-1 truncate text-xs leading-5 text-gray-500">
                      {order.selectAddress && order.selectAddress.street}
                    </p>
                  </div>
                </div>
                <div className="hidden shrink-0 sm:flex sm:flex-col sm:items-end">
                  <p className="text-sm leading-6 text-gray-900">
                    {order.selectAddress && order.selectAddress.phone}
                  </p>
                  <p className="text-sm leading-6 text-gray-500">
                    {order.selectAddress && order.selectAddress.city}
                  </p>
                </div>
              </div>
            </div>
