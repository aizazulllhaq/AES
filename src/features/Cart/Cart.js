...
import { deleteCartItemAsync, selectItems, updateCartItemAsync } from "./cartSlice";
              ...
              <li key={item.id} className="flex py-6">
                ...
                <div className="ml-4 flex flex-1 flex-col">
                  ...
                  <div className="flex flex-1 items-end justify-between text-sm">
                    ...
                    <select className='rounded ml-3' onChange={(e)=>handleQuantity(e,item)} value={item.quantity}>
